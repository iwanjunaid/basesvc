...
func (m *MockAuthorCacheRepository) Find(ctx context.Context) ([]*model.Author, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthorCacheRepositoryMockRecorder) Find(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockAuthorCacheRepository)(nil).Find), ctx)
}

// Create mocks base method
func (m *MockAuthorCacheRepository) Create(ctx context.Context) error {
	m.ctrl.T.Helper()
...
// Create indicates an expected call of Create
func (mr *MockAuthorCacheRepositoryMockRecorder) Create(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockAuthorCacheRepository)(nil).Create), ctx)
}
...
func (m *MockAuthorEventRepository) Publish(ctx context.Context, topic string, key, message []byte) error {
	m.ctrl.T.Helper()
...
func (mr *MockAuthorEventRepositoryMockRecorder) Publish(ctx, topic, key, message interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Publish", reflect.TypeOf((*MockAuthorEventRepository)(nil).Publish), ctx, topic, key, message)
}
